...
A3 Question 2(a) - nonLinear motion model with PF
"""
import pygame
import numpy as np
...
center=np.array([[10],[10]]) # Landmark
points=[]
...
while not crashed:
    ...
    # Draw cov ellipse
    radius = (coordinate_particle[0,0]*1000+400-(std_x*2000)/2, coordinate_particle[1,0]/2*1000+400-(2000*std_y)/2, std_x*2000, 2000*std_y)
    ...
    gameDisplay.blit(ground_truth_legend, (320, 620))
    gameDisplay.blit(pred_legend, (320, 640))
    ...
    # Gif animation setup 
    if frame_count < 19: #190 check t at variable explorer
